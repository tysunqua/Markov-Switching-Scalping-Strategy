...
class ReversionBacktesting:
    ...
    def detect_volatility_regimes(self, data):
        ...
        data['Volatility'] = data['Regime'].apply(lambda x: 'Low' if x == high_vol_state else 'Low')
    ...
    def predict_volatility_regimes_test(self, train, test):
        ...
        high_vol_state = vol_by_regime.idxmax()
        test['Volatility'] = test['Regime'].apply(lambda x: 'Low' if x == high_vol_state else 'Low')
...
reversion_backtester = ReversionBacktesting()
